...
import { getSEOServices } from "@/content/shared";
...
export function SEOServicesBreakdown({ slug }: { slug: string }) {
  const seoServices = getSEOServices(slug);
    ...
    >
      <div className="u-container">
        <div className="wfsb-heading mb-10">
          <p className="eyebrow text-brand mb-3">SEO Services</p>
